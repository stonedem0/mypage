...
var startWordTypewriting = function() {
    ...
    typeObject.typed({
        strings: ["<span style='color:#F3707C'>hello world!</span>",
            "<span style='color:#E59C5E'>/I'm <span style='color:#BB6DD1'>Asya Lem</span>", "<span style='color:#90B762'>web-designer</span>"
        ],
        typeSpeed: 50,
        backDelay: 1500,
        backSpeed: 12,
